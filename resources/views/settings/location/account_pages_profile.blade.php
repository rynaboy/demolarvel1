...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ;"  style="zoom:85%;margin-left:7%;max-width:1240px ; max-height:1754px ">
                ...
                <div class="card border shadow-xs mb-4">
                    <div class="card-header border-bottom pb-0">
                        <div class="d-sm-flex align-items-center">
                            <div>
                                <h6 style="margin-top: -8px; font-weight:bold">បញ្ជីអ្នកប្រើប្រាស់</h6>
                            </div>
                    ...
                    <div class="card-body px-0 py-0">
                        ...
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                <thead class="bg-gray-100">
                                    <tr>
                                        <th class="text-secondary text-xs font-weight-semibold opacity-7" style="font-size: 15px !important">សមាជិក
                                        </th>
                                        <th class="text-secondary text-xs font-weight-semibold opacity-7 ps-2" style="font-size: 15px !important">
                                            តួនាទី</th>
                                        <th
                                            class="text-center text-secondary text-xs font-weight-semibold opacity-7" style="font-size: 15px !important">
                                            សម្មភាព</th>
                                        <th
                                            class="text-center text-secondary text-xs font-weight-semibold opacity-7" style="font-size: 15px !important">
                                            បានធ្វើការ</th>
                                        <th class="text-secondary opacity-7" style="font-size: 15px !important"></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="align-middle text-center text-sm">
                                            <span
                                                class="badge badge-sm border border-success text-success bg-success">ក្នុងប្រព័ន្ធ</span>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center text-sm">
                                            <span
                                                class="badge badge-sm border border-secondary text-secondary bg-secondary">ក្រៅប្រព័ន្ធ</span>
                                        </td>
                                        <td class="align-middle text-center">
                        ...
                        <div class="border-top py-3 px-3 d-flex align-items-center">
                            <p class="font-weight-semibold mb-0 text-dark text-sm">ទំព័រ ១ នៃ​ ១០</p>
                            <div class="ms-auto">
                                <button class="btn btn-sm btn-white mb-0">ត្រឡប់</button>
                                <button class="btn btn-sm btn-white mb-0">បន្ទាប់</button>
                            </div>
                        </div>
                    </div>
                </div>
