...
$commune = [
    ...
    [
        ...
        "khmer_name" => "សង្កាត់ស្មាច់មានជ័យ",
        "total_village" => "5"
    ],
  "1"  =>
   [
        "code" => "90402",
        "name" => "Dang Tong Sangkat",
        "khmer_name" => "សង្កាត់ដងទង់",
        "total_village" => "4"
  ],
  "2"  =>
   [
        "code" => "90403",
        "name" => "Stueng Veaeng Sangkat",
        "khmer_name" => "សង្កាត់ស្ទឹងវែង",
        "total_village" => "2"
  ],
];
                            ...
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0">
                                    <thead class="bg-gray-100">
                                        <tr >
                                            <th class="text-secondary text-xs font-weight-semibold opacity-7">លេខកូដ
                                            </th>
        ...
        <td>
            <div class="d-flex px-2 py-1">
                ...
                <div class="d-flex flex-column justify-content-center ms-1">
                    <h6 class="mb-0 text-sm font-weight-semibold"><?=$code ?></h6>

                </div>
            </div>
        </td>
        <td>
            <p class="text-sm text-dark font-weight-semibold mb-0"><?=$khmer_name ?></p>
        </td>
        <td>
