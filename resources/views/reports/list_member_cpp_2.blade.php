<div class="container">
 ...
 <main class="main-content " style="max-width:1240px ; max-height:1754px ;"id="report">
                ...
                <div class="col-12">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody style="text-align:center">
                            <tr>
                                <td colspan="13"><h6 style="margin-left:-90%;font-weight: 400">ខ្នងផ្ទះទី <span>1</span>  គ្រួសារទី <span>1</span></h6></td>
                              </tr>
                              <tr>
                                <td>1</td>
    ...
    function print() {
        ...
        printWindow.document.write('<style>body{zoom:80%;font-family:Battambang;margin-left:-20px; }  </style>');
